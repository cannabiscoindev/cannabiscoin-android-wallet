...
package com.cannabiscoinfs420.wallet.util;
...
public class GenericUtilsTest
{
	...
	public void formatValue() throws Exception
	{
		...
		assertEquals("420000000.00", GenericUtils.formatValue(NetworkParameters.MAX_MONEY, 8, 0));
	}
	...
	public void formatMbtcValue() throws Exception
	{
		...
		assertEquals("420000000000.00", GenericUtils.formatValue(NetworkParameters.MAX_MONEY, 5, 3));
	}
}
